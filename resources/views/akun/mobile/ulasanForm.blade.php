    ...
    <div>
      ...
      <div class="mt-3 flex justify-center">
        <div class="w-32 rounded relative flex items-center justify-center">
          ...
          <button id="ulasan_btn_kirim" class="w-60 bg-sky-500 border rounded text-white text-sm font-bold py-2"><i class="fa fa-paper-plane"></i> Kirim</button>
        </div>
      </div>
    </div>
  </form>
      ...
      if (rating == 0) {     
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            window.location.href = "{{ URL::route('mUlasan') }}";
